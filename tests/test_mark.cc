...
TEST( Mark, mmix ) {
    ...
    void *pmem0 = mark_memarea_and_get_user_ptr(32, (uint8_t *)tab, SMALL_KIND);
    ...
    void *pmem1 = mark_memarea_and_get_user_ptr(40, (uint8_t *)tab, SMALL_KIND);
    memset(pmem1, 0, 8);
    ...
    void *pmem32 = mark_memarea_and_get_user_ptr(64, (uint8_t *)tab, SMALL_KIND);
    memset(pmem32, 0, 32);
